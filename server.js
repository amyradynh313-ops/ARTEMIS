...
async function generateWithPollinations(prompt) {
  // بدون کلید، بدون ثبت‌نام، بدون Billing — همیشه در دسترسه
...
function detectImageProvider() {
  ...
  // اگه هیچ کلیدی ست نشده بود، به‌صورت خودکار از Pollinations استفاده کن
  // (نیازی به کلید یا Billing نداره، همیشه کار می‌کنه)
  return 'pollinations';
}
